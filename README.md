...
An AI-powered Telegram chatbot built using **n8n**, **Groq**, and **Telegram Bot API**.
...
2. Create your own Telegram credentials.
3. Create your own Groq credentials.
...
<p align="center">
  <img src="workflow.jpeg" alt="Workflow" width="1000"/>
</p>
